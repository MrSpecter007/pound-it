...
class InterruptionGrossesse(BaseServiceProfile):
    ...
    gestational_age = models.CharField(max_length=255, null=True, blank=True,
                                       verbose_name="Âge gestationnel")  # IG only
    pregnancy_termination_method = models.CharField(max_length=255, null=True, blank=True,
                                                    verbose_name="Méthod d'interruption de grossesse")  # IG only
    ...
    def fields_needed_for_agent(self) -> list[list[str | Any]]:
        ...
        return (general_fields +
                ...
                + [
                    ...
                    [self._meta.get_field("gestational_age").verbose_name, self.gestational_age],
                    [self._meta.get_field("pregnancy_termination_method").verbose_name,
                     self.pregnancy_termination_method],
